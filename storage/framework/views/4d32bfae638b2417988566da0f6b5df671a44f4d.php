...
<?php $__env->startSection('content'); ?>
      ...
      <div class="tengah">
            ...
            <div class="berita">
                <img class="gambarB" src="<?php echo e(asset('img/berita1.jpg')); ?>" alt="gambar">
            ...
            <div class="berita">
                <img class="gambarB" src="<?php echo e(asset('img/berita2.jpg')); ?>" alt="gambar">
            ...
            <div class="berita">
                <img class="gambarB2" src="<?php echo e(asset('img/berita3.jpg')); ?>" alt="gambar">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\UMM\Semester4\Praktikum\web\tryLaravel\modul5\resources\views/index.blade.php ENDPATH**/ ?>